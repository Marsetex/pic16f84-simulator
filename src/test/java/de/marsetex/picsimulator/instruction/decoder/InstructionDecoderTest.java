...
public class InstructionDecoderTest {
    ...
    public void testDecodeMovlw() {
        ...
        IInstruction instruction = decoder.decode(Short.parseShort(movlwOpcode, 16));
    ...
    public void testDecodeIorlw() {
        ...
        IInstruction instruction = decoder.decode(Short.parseShort(iorlwOpcode, 16));
    ...
    public void testDecodeAndlw() {
        ...
        IInstruction instruction = decoder.decode(Short.parseShort(andlwOpcode, 16));
    ...
    public void testDecodeXorlw() {
        ...
        IInstruction instruction = decoder.decode(Short.parseShort(xorlwOpcode, 16));
    ...
    public void testDecodeSublw() {
        ...
        IInstruction instruction = decoder.decode(Short.parseShort(sublwOpcode, 16));
    ...
    public void testDecodeAddlw() {
        ...
        IInstruction instruction = decoder.decode(Short.parseShort(addlwOpcode, 16));
